...
const Home: NextPage = () => {
  ...
  return (
    <div className='bg-bgColor text-black flex w-screen flex-col h-screen'>
      ...
      <div className='flex h-[5rem] w-full bg-white items-center p-5 justify-between' style={{background:"linear-gradient(84deg, rgba(69, 198, 254, 1), rgb(104 117 233))"}}>
      ...
      <div className='flex flex-col w-full h-full items-center justify-center gap-y-10' style={{background:"linear-gradient(163deg, rgba(69, 198, 254, 1), rgba(147, 18, 207, 1))"}} >
